          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <small>Silahkan Login Menggunakan Username dan Password Anda!</small>
              </div>
              <form method="post" role="form" action="<?php echo base_url("index.php/admin/loginvalidation"); ?>">
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
			...
			?>
			  ...
			  ?> <a href="#" class="font-weight-bold ml-1" target="_blank">Anugraf PS</a>
            </div>
          </div>
          <div class="col-xl-6">
